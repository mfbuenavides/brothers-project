...
<div class="fieldcontain ${hasErrors(bean: priceSettingInstance, field: 'pricePerInitialTenKg', 'error')} required">
	...
	<g:field name="pricePerInitialTenKg" type="number" value="${fieldValue(bean: priceSettingInstance, field: 'pricePerInitialTenKg')}" required=""/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: priceSettingInstance, field: 'priceSuccceedingKg', 'error')} required">
	...
	<g:field name="priceSuccceedingKg"  type="number" value="${fieldValue(bean: priceSettingInstance, field: 'priceSuccceedingKg')}" required=""/>
</div>
