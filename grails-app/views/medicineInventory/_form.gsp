...
<div class="fieldcontain ${hasErrors(bean: medicineInventoryInstance, field: 'cost', 'error')} required">
	...
	<g:field name="cost" value="${fieldValue(bean: medicineInventoryInstance, field: 'cost')}" required=""/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: medicineInventoryInstance, field: 'quantity', 'error')} required">
	...
	<g:field name="quantity" value="${fieldValue(bean: medicineInventoryInstance, field: 'quantity')}" required=""/>
</div>
